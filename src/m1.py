...
class CircleChanger(object):
    ...
    def get_distance_from(self, point):
        ...
        ################################################################
        xx=self.circle.center.x-point.x
        yy=self.circle.center.y-point.y
        xxs=xx**2
        yys=yy**2
        disS=xxs+yys
        dis=disS**0.5
    ...
    def swallow(self, other_circle_changer):
        ...
        point=rg.Point(self.circle.center.x,self.circle.center.y)
        radiusdub=point.get_distance_from(other_circle_changer.circle.center)
        radius=radiusdub*0.5
